...
public protocol FeatureProvider: EventPublisher {
    ...
    /// Evaluates a boolean feature flag with optional logger support.
    ///
    ...
    ///
    /// - Parameter logger: Optional logger for debugging and diagnostics during evaluation
    func getBooleanEvaluation(key: String, defaultValue: Bool, context: EvaluationContext?, logger: Logger?) throws
        -> ProviderEvaluation<
            Bool
        >

    /// Evaluates a string feature flag with optional logger support.
    ///
    /// Override this method to receive and use the logger during flag evaluation.
    /// If not overridden, the default implementation delegates to
    ...
    /// Evaluates an integer feature flag with optional logger support.
    ///
    /// Override this method to receive and use the logger during flag evaluation.
    /// If not overridden, the default implementation delegates to
    ...
    /// Evaluates a double feature flag with optional logger support.
    ///
    /// Override this method to receive and use the logger during flag evaluation.
    /// If not overridden, the default implementation delegates to
    ...
    /// Evaluates an object feature flag with optional logger support.
    ///
    /// Override this method to receive and use the logger during flag evaluation.
    /// If not overridden, the default implementation delegates to
